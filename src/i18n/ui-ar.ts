...
export const uiAr = {
  ...
  chant: {
    ...
    editSync: 'تعديل المزامنة',
    editSyncOn: 'تعديل',
    editSyncOff: 'إيقاف',
    syncEditLine: 'سطر',
    syncEditNudgeHint: 'ضبط بداية السطر الحالي',
    syncEditHint: 'استمع واضبط السطر المميز. يُحفظ المسودة في هذا المتصفح.',
    syncEditDraftSaved: 'مسودة محفوظة محلياً',
    syncEditDraftRestored: 'تمت استعادة المسودة المحلية',
    syncEditCopyJson: 'نسخ JSON',
    syncEditDownloadJson: 'تنزيل التصحيح',
    syncEditReset: 'إعادة',
    syncEditOpenPr: 'فتح PR للمزامنة',
    syncEditCopied: 'تم نسخ JSON',
    syncEditCopyFailed: 'تعذّر النسخ',
    syncEditDownloaded: 'بدأ التنزيل',
    syncEditResetDone: 'أُعيد إلى الأوقات المنشورة',
    syncEditNudged: 'ضُبط',
    syncEditNoChanges: 'لا تغييرات للإرسال',
    syncEditPrSubmitting: 'جارٍ فتح PR…',
    syncEditPrOk: 'تم إنشاء PR',
    syncEditPrFailed: 'تعذّر إنشاء PR',
