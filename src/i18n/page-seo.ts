...
export const PAGE_SEO: Record<Locale, PageSeoBundle> = {
  ...
  ar: {
    siteDefaultDescription:
      'إرث بشري في الصوت. مكتبة حية للترانيم المقدّسة — للحفاظ على الوصول إلى الحالات الداخلية التي يفتحها الصوت المقدّس.',
    homeDescription:
      'مكتبة حية لإرث البشرية الروحي في الصوت. ترانيم مقدّسة ومنترات وأناشيد وصلوات من تقليدات مختلفة — محفوظة ومشتركة للاستماع والتأمل وإعادة الاتصال.',
    chantsIndexDescription: 'تصفّح جميع الترانيم المقدّسة في المكتبة.',
    knowledge: {
      nadaYoga:
        'النادا يوغا: يوغا الصوت والاهتزاز. التعريف، الصوت المسموع وغير المسموع، مراجع كلاسيكية.',
      vibrationMind:
        'كيف تؤثر اهتزازات الصوت على آلة العقل؛ الرنين والنية والمسموع وغير المسموع.',
      elementsAndSound:
        'العناصر الخمسة وعلاقتها بالصوت. الآكاشا والشَبْدا؛ التوازن والانسجام.',
      soundAttributes:
        'الطبقة والشدة والطابع الزمني، وكيف ترتبط خصائص الصوت بالعناصر الخمسة وتنسّق المستمع.',
      balanceAndHealing:
        'الفرق بين التوازن اللحظي والشفاء الأعمق. الصوت المقدّس، ذوبان الأنا، والاتصال بالوجود الكامل.',
      soundAndHumanity:
        'الصوت والإنسانية: كيف رعت الثقافات الغناء؛ الصوت في الطبيعة؛ المقدّس والحالات الداخلية عبر الصوت.',
      references: 'مراجع وقراءات إضافية حول الناادا يوغا والعناصر الخمسة.',
    },
    mainNavAriaLabel: 'التنقّل الرئيسي',
    localeSelectAriaLabel: 'اختر اللغة',
    openMenuAriaLabel: 'فتح القائمة',
    siteMenuAriaLabel: 'قائمة الموقع',
    footerLine: 'مفتوح المصدر · بلا إعلانات · إرث إنساني · تأمّلي',
  },
};
