...
- [x] `npm run verify` passa (testes + build + dados de locale gerados); e2e em `e2e/locale.spec.ts` (com `E2E_SKIP_BUILD=1` após build local se o preview falhar a compilar em paralelo — ver `docs/I18N-LOCALIZATION.md`).
